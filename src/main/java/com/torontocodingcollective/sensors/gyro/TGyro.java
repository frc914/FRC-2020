...
public abstract class TGyro extends GyroBase {
     ...
     */
    protected TGyro(final boolean isInverted) {
     ...
     */
    protected double getRate(final double rawRate) {
     ...
     */
    private double normalizedAngle(final double rawAngle) {
    ...
    public void setGyroAngle(final double angle) {
